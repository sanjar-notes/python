...
class VampireKing(Vampire):
    ...
    def __init__(self, name):
        super().__init__(name)  # starts off with 140 HP
        self.hit_points = 140 # setting the HP to 140

    def take_damage(self, damage):
        return super().take_damage(damage/4) # takes damage/4

if __name__ =='__main__':
    dracula = VampireKing('Dracula')
    for i in range(10000):
        dracula.take_damage(100)
        if dracula.alive == False:
            break
